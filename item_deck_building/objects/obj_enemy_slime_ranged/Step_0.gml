...
if(hp > 0)
	...
	else if(sprite_index == atk_spr and attacked == 0)
	{
		if(image_index >= 11 and image_index_prev < 11)
		{
			repeat(3)
			{
				var incy = instance_create_layer(x,y,"player",obj_enemy_slime_ranged_arrow);
				incy.image_xscale = image_xscale*4;
				incy.hspeed = random_range(8,24)*image_xscale;
				incy.vspeed = random_range(-18,-24);
				incy.obj = id;
			}
		}
	}
